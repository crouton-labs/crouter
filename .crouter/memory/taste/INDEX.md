...
- **surface-parity** — the ruling that a change in a node's attached TUI owes the web UI's operator view too (near-parity), and often a friendlier studio-view treatment, because all three are views of the one broker host.
