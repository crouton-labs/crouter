...
export const readLeaf = defineLeaf({
  ...
  whenToUse: 'a task in front of you matches a skill that is already loaded — read it BEFORE you start improvising, not after. Reach for it the moment you are about to do something a skill covers: adopting a documented workflow that fits the task at hand, following a methodology before writing a spec or a plan, picking up the house conventions for a tool or framework, replaying a runbook for an operation you have run before. You name the skill by its crtr identifier, never a file path — do not cat or find SKILL.md off disk. Reach for `crtr skill find` first when you do not yet know which skill applies.',
  help: {
    name: 'skill read',
